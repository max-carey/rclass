...
# *Overview*
En esta unidad, vamos a aplicar lo que vimos en el curso *Introduction to the Tidyverse* a dos bases de datos lexicográficos: *A Frequency Dictionar of Spanish* y *English Grammar Profile*; y unos datos sociofonéticos.


# ¿Cómo cargar datos en R?
Los primeros datos linguüísticos que vamos a cargar vienen de un diccionario de frecuencia llamado [*A Frequency Dictionary of Spanish: Core Vocabulary for Learners (Routledge Frequency Dictionaries)*](https://www.amazon.com/Frequency-Dictionary-Spanish-Vocabulary-Dictionaries/dp/0415334292). El diccionario está pensado en los aprendices del español.
